                    ...
                    if($scope.blockNumber!==undefined){
                        ...
                        getTransactionReceipt()
                            .then(function (result) {
                                console.log(result)
                                switch (result.to) {
                                    case "0x60dd8e2378163e8cb4362b2c06f87b7a774b696e":
                                        ...
                                        $scope.tokenValue = web3.fromWei(parseInt(result.logs[0].data),'ether') + " HDAO";
                                        $scope.txprice = web3.fromWei(result.gasUsed * gasPrice,'ether') + " HAIC";
                                        break;
                                    default:
                                        $scope.tokenFrom = "0x";
                                        $scope.tokenTo = "0x";
